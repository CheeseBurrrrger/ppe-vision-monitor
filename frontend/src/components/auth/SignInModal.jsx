        ...
        <form onSubmit={handleSubmit} className="px-6 py-6 space-y-4">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              required
              autoFocus
              className="w-full px-3 py-2 rounded-md border-2 border-green-700 bg-white text-sm text-[#1a1a1a] outline-none focus:ring-2 focus:ring-green-700/20 transition"
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <input
                ...
                required
                minLength={6}
                className="w-full px-3 py-2 pr-10 rounded-md border-2 border-green-700 bg-white text-sm text-[#1a1a1a] outline-none focus:ring-2 focus:ring-green-700/20 transition"
              />
              <button
                type="button"
          ...
          {/* Role */}
          <div className="space-y-1">
            <label className="text-xs font-medium text-gray-600">Peran</label>
            <select
              value={role}
            ...
            >
              ...
              <option value="manager">Manager (catat &amp; validasi)</option>
            </select>
          </div>
